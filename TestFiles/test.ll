...
target triple = "x86_64-pc-windows-msvc19.35.32215"
...
@__const.main.c = private unnamed_addr constant [8 x i32] [i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8], align 16
@__const.main.a = private unnamed_addr constant [3 x i32] [i32 2, i32 1, i32 1], align 4
...
define dso_local i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 16 %2, ptr align 16 @__const.main.c, i64 32, i1 false)
  store i32 0, ptr %3, align 4
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %4, ptr align 4 @__const.main.a, i64 12, i1 false)
  %6 = getelementptr inbounds [3 x i32], ptr %4, i64 0, i64 0
  ...
  %15 = getelementptr inbounds [8 x i32], ptr %2, i64 0, i64 %14
